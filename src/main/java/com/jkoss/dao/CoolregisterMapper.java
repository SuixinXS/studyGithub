...
/*    @Select("select a.*,b.company_name,b.ctm_name,b.ctm_phone from coolregister as a left join customer as b on a.ctm_id=b.ctm_id order by a.ctm_id desc")*/
    List<CoolregisterVoCtm>lsCold(Page<CoolregisterVoCtm> page);
    
    @Select("select a.*,b.company_name,b.ctm_name,b.ctm_phone from coolregister as a left join customer as b on a.ctm_id=b.ctm_id where a.regist_id=#{rid}")
